  ...
  return (
    <LegalDocument title="Privacy Policy">
        <div className="space-y-12 leading-relaxed text-copy-muted">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">1. Information We Collect</h2>
            
            <h3 className="mb-3 font-display text-xl text-copy">1.1 Information You Provide</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 font-display text-xl text-copy">1.2 Information from Third-Party Services</h3>
            <p className="mb-4">
            ...
            <h3 className="mb-3 font-display text-xl text-copy">1.3 Automatically Collected Information</h3>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">3. Data Storage and Security</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">4. Data Sharing and Disclosure</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">5. Third-Party Services</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">6. Your Rights and Choices</h2>
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">7. Cookies and Tracking Technologies</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">8. Children&apos;s Privacy</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">9. International Data Transfers</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">10. Changes to This Privacy Policy</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="mb-4 font-display text-2xl text-copy">11. Contact Us</h2>
            <p className="mb-4">
